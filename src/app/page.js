...
export default function Home() {
  return (
    <div>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border px-4 py-2">
                    <p>
                      Über die heutigen Stand der Micellartheorie auf
                      botanischem Gebiete.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">1925</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="border px-4 py-2">Steinbrinck, 1925, 9</td>
                </tr>
                <tr className="">
                  <td className="border px-4 py-2"></td>
                  <td className="border px-4 py-2">
                    <p>
                      <strong>ID</strong> Steinbrinck-1925-2b
                    </p>
                  </td>
                </tr>
                <tr className="">
                ...
                <tr className="">
                  ...
                  <td className="border px-4 py-2">
                    <p>
                      <strong>Beschreibung</strong> Abb. 2b. Röntgendiagramm der
                      Ramié-Faser, Strahl parallel den Fasern.
                    </p>
                  </td>
                </tr>
                <tr className="">
                  ...
                  <td className="border px-4 py-2">
                    <p>
                      <strong>Personen </strong> Steinbrinck
                    </p>
                  </td>
                </tr>
                <tr className="">
                ...
                <tr className="">
                  ...
                  <td className="border px-4 py-2">
                    <p>
                      <strong>Sachbegriffe </strong> Foto, Institutionen,
                      Makroorganismen, Medientechnik, Objekte, Organismen,
                      Organismenteile,Pflanzen, Röntgenbild
                    </p>
                  </td>
                </tr>
              </tbody>
      ...
      <div className="map-image px-5 lg:px-10 xl:px-32 py-10 bg-accentGreen">
        <Image
          alt="dotted image"
          src="/images/map.svg"
          className="rounded-lg"
